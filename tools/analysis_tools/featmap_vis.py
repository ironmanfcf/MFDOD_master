...
def parse_args():
    ...
    parser.add_argument(
        '--img', default='/opt/data/private/fcf/mmdetection/data/HazyDet-365k/val/images/', help='Image path, include image file, dir and URL.')
    parser.add_argument('--config',default='/opt/data/private/fcf/mmdetection/tools/work_dirs/FCOS_DeCoDet_vanilla/FCOS-R50-DeCoDetV16_SGD-0.005-autolr_b2/fcos_r50-caffe_fpn_gn-head_1x_coco.py', help='Config file')
    parser.add_argument('--checkpoint',default='/opt/data/private/fcf/mmdetection/tools/work_dirs/FCOS_DeCoDet_vanilla/FCOS-R50-DeCoDetV16_SGD-0.005-autolr_b2/epoch_12.pth',help='Checkpoint file')
    parser.add_argument(
        '--out-dir', default='/opt/data/private/fcf/mmdetection/tools/fatture_map_vis/FCOS-R50-DeCoDetV16', help='Path to output file')
    parser.add_argument(
        '--target-layers',
        default=['backbone'],
        nargs='+',
